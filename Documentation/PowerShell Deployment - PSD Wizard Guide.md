...
2. [Import Operating Systems](#import-operating-systems)
3. [Create PSD Task Sequences](#create-psd-task-sequences)
4. [Create Applications](#create-applications)
5. [Import / Add Drivers](#import--add-drivers)
   - [Sample Syntax](#sample-syntax)
6. [Check Deployment Share Permissions](#check-deployment-share-permissions)
7. [Update Windows PE Settings](#update-windows-pe-settings)
8. [Enable MDT Monitoring](#enable-mdt-monitoring)
9. [Update CustomSettings.ini](#update-customsettingsini)
10. [Update Bootstrap.ini](#update-bootstrapini)
11. [Update Background Wallpaper](#update-background-wallpaper)
12. [Configure Extra Files](#configure-extra-files)
13. [Readiness Checks](#readiness-checks)
14. [Certificates](#certificates)
15. [Configure WinPE Drivers](#configure-winpe-drivers)
16. [Generate New Boot Media](#generate-new-boot-media)
17. [Content Caching and Peer-to-Peer Support](#content-caching-and-peer-to-peer-support)
